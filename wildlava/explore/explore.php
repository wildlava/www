...
if (isset($advname))
{
    ...
    if (isset($command))
    {
        ...
        $fp = popen("/bin/python3 explore.py --one-shot -c " . $esc_command . " -f $advname.exp -r " . escapeshellarg($state) . $suspend_param, "r");
    ...
    else
    {
        ...
        $fp = popen("/bin/python3 explore.py --one-shot -f $advname.exp" . $suspend_param, "r");
